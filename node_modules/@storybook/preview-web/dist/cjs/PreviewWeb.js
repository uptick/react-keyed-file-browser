...
var PreviewWeb = /*#__PURE__*/function (_Preview) {
  ...
  function PreviewWeb() {
    ...
    var urlStore = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new _UrlStore.UrlStore();
    var webview = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : new _WebView.WebView();
  ...
  _createClass(PreviewWeb, [{
    ...
    value: function setupListeners() {
      ...
      this.channel.on(_coreEvents.PRELOAD_STORIES, this.onPreloadStories.bind(this));
    }
  }, {
    ...
    value: function initializeWithStoryIndex(storyIndex) {
      ...
      return _get(_getPrototypeOf(PreviewWeb.prototype), "initializeWithStoryIndex", this).call(this, storyIndex).then(function () {
        ...
        if (!((_global$FEATURES = _global.default.FEATURES) !== null && _global$FEATURES !== void 0 && _global$FEATURES.storyStoreV7)) {
          _this3.channel.emit(_coreEvents.SET_STORIES, _this3.storyStore.getSetStoriesPayload());
        }
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.t1 = _coreEvents.SET_STORIES;
                _context4.next = 7;
    ...
    value: function renderException(storyId, err) {
      this.channel.emit(_coreEvents.STORY_THREW_EXCEPTION, err);
