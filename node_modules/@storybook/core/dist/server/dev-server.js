...
function _default(options) {
  ...
  const managerPromise = (0, _managerConfig.default)(_objectSpread({
    ...
    const managerCompiler = (0, _webpack.default)(config);
    ...
    const managerDevMiddlewareInstance = (0, _webpackDevMiddleware.default)(managerCompiler, devMiddlewareOptions);
  ...
  const previewPromise = options.ignorePreview ? new Promise(resolve => resolve()) : (0, _config.default)(_objectSpread({
    ...
    const previewDevMiddlewareInstance = (0, _webpackDevMiddleware.default)(previewCompiler, devMiddlewareOptions);
