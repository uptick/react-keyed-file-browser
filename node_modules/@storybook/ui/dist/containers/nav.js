...
exports["default"] = exports.mapper = exports.collapseDocsOnlyStories = exports.collapseAllStories = void 0;
...
var createMenu = (0, _memoizerific["default"])(1)(function (api, shortcutKeys, isFullscreen, showPanel, showNav, enableShortcuts) {
  return [{
    id: 'S',
    title: 'Show sidebar',
    ...
    right: (0, _shortcut.shortcutToHumanString)(shortcutKeys.collapseAll),
    left: _ref15
  }];
});
...
var collapseAllStories = function collapseAllStories(stories) {
  ...
  var componentsFlattened = leavesRemoved.map(function (item) {
    ...
    var component = Object.assign({}, rest, {
      id: leafId,
      isLeaf: true,
      isComponent: true
    });
...
var collapseDocsOnlyStories = function collapseDocsOnlyStories(storiesHash) {
  ...
  var docsOnlyComponentsCollapsed = docsOnlyStoriesRemoved.map(function (item) {
    ...
    if (isComponent && children.length === 1) {
      ...
      if (leafId) {
        var collapsed = Object.assign({}, item, {
          id: leafId,
          isLeaf: true,
          children: undefined
        });
...
var mapper = function mapper(_ref16) {
  ...
  var stories = _global.DOCS_MODE ? collapseAllStories(storiesHash) : collapseDocsOnlyStories(storiesHash);
